...
If you would like to return to [**creating your Kianda process**](getting-started/create_process.md), then follow the steps below:
...
- [**Adding controls and rules**](getting-started/add_form_elements.md)